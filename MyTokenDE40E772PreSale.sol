...
import "./MyTokenDE40E772.sol";

contract MyTokenDE40E772PreSale {
    MyTokenDE40E772 public token;
    ...
    function MyTokenDE40E772PreSale(
        MyTokenDE40E772 _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = MyTokenDE40E772(_token);
